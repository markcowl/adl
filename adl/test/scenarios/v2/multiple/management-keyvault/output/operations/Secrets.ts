export interface Secrets {
     ...
     */
    CreateOrUpdate(resourceGroupName: string, vaultName: string & RegularExpression<'^[a-zA-Z0-9-]{3,24}$'>, secretName: string & RegularExpression<'^[a-zA-Z0-9-]{1,127}$'>, api_version: ApiVersionParameter, subscriptionId: SubscriptionIdParameter, parameters: Body<SecretCreateOrUpdateParameters, 'application/json'>): [(code: 200, mediaType: "application/json") => {
        body: Secret;
     ...
     */
    Update(resourceGroupName: string, vaultName: string & RegularExpression<'^[a-zA-Z0-9-]{3,24}$'>, secretName: string & RegularExpression<'^[a-zA-Z0-9-]{1,127}$'>, api_version: ApiVersionParameter, subscriptionId: SubscriptionIdParameter, parameters: Body<SecretPatchParameters, 'application/json'>): [(code: 200, mediaType: "application/json") => {
        body: Secret;
    }, (code: 201, mediaType: "application/json") => {
        body: Secret;
    }];
