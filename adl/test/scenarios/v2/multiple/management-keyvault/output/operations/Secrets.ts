export interface Secrets {
     ...
     */
    Get(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string>, secretName: Http.Path<string>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, body?: Http.Body<file, 'application/json'>): Http.Response<'200', Secret, 'application/json'>;
    /**
     ...
     */
    CreateOrUpdate(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<'^[a-zA-Z0-9-]{3,24}$'>>, secretName: Http.Path<string & RegularExpression<'^[a-zA-Z0-9-]{1,127}$'>>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<SecretCreateOrUpdateParameters, 'application/json'>): Http.Response<'200', Secret, 'application/json'> | Http.Response<'201', Secret, 'application/json'>;
    /**
     ...
     */
    Update(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<'^[a-zA-Z0-9-]{3,24}$'>>, secretName: Http.Path<string & RegularExpression<'^[a-zA-Z0-9-]{1,127}$'>>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<SecretPatchParameters, 'application/json'>): Http.Response<'200', Secret, 'application/json'> | Http.Response<'201', Secret, 'application/json'>;
    /**
     ...
     */
    List(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string>, __top?: Http.Query<int32, '$top'>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, body?: Http.Body<file, 'application/json'>): Http.Response<'200', SecretListResult, 'application/json'>;
}
