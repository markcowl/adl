export interface Vaults {
     ...
     */
    Get(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, body?: Http.Body<file, 'application/json'>): Http.Response<'200', Vault, 'application/json'>;
    /**
     ...
     */
    CreateOrUpdate(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<'^[a-zA-Z0-9-]{3,24}$'>>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<VaultCreateOrUpdateParameters, 'application/json'>): Http.Response<'200', Vault, 'application/json'> | Http.Response<'201', Vault, 'application/json'>;
    /**
     ...
     */
    Update(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<'^[a-zA-Z0-9-]{3,24}$'>>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<VaultPatchParameters, 'application/json'>): Http.Response<'200', Vault, 'application/json'> | Http.Response<'201', Vault, 'application/json'>;
    /**
     ...
     */
    UpdateAccessPolicy(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<'^[a-zA-Z0-9-]{3,24}$'>>, operationKind: Http.Path<AccessPolicyUpdateKind>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<VaultAccessPolicyParameters, 'application/json'>): Http.Response<'200', VaultAccessPolicyParameters, 'application/json'> | Http.Response<'201', VaultAccessPolicyParameters, 'application/json'>;
    /**
     ...
     */
    ListByResourceGroup(resourceGroupName: Http.Path<string>, __top?: Http.Query<int32, '$top'>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, body?: Http.Body<file, 'application/json'>): Http.Response<'200', VaultListResult, 'application/json'>;
    /**
     ...
     */
    ListBySubscription(__top?: Http.Query<int32, '$top'>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, body?: Http.Body<file, 'application/json'>): Http.Response<'200', VaultListResult, 'application/json'>;
    /**
     ...
     */
    ListDeleted(api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, body?: Http.Body<file, 'application/json'>): Http.Response<'200', DeletedVaultListResult, 'application/json'>;
    /**
     ...
     */
    GetDeleted(vaultName: Http.Path<string>, location: Http.Path<string>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, body?: Http.Body<file, 'application/json'>): Http.Response<'200', DeletedVault, 'application/json'>;
    /**
     ...
     */
    List(__filter: Http.Query<"resourceType eq 'Microsoft.KeyVault/vaults'", '$filter'>, __top?: Http.Query<int32, '$top'>, api_version: Http.Query<"2015-11-01", 'api-version'>, subscriptionId: Http.Path<string>): Http.Response<'200', ResourceListResult, 'application/json'>;
    /**
     ...
     */
    CheckNameAvailability(api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, vaultName: Http.Body<VaultCheckNameAvailabilityParameters, 'application/json'>): Http.Response<'200', CheckNameAvailabilityResult, 'application/json'>;
}
