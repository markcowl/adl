...
export interface Vaults {
     ...
     * @since 2019-09-01
     */
    Get(body?: Http.Body<file, 'application/json'>, resourceGroupName: Http.Path<string>, vaultName: Http.Path<string>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>);
    /**
     ...
     * @since 2019-09-01
     */
    CreateOrUpdate(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<"^[a-zA-Z0-9-]{3,24}$">>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<schema, 'application/json'>);
    /**
     ...
     * @since 2019-09-01
     */
    Delete(body?: Http.Body<file, 'application/json'>, resourceGroupName: Http.Path<string>, vaultName: Http.Path<string>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>);
    /**
     ...
     * @since 2019-09-01
     */
    Update(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<"^[a-zA-Z0-9-]{3,24}$">>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<schema, 'application/json'>);
    /**
     ...
     * @since 2019-09-01
     */
    UpdateAccessPolicy(resourceGroupName: Http.Path<string>, vaultName: Http.Path<string & RegularExpression<"^[a-zA-Z0-9-]{3,24}$">>, operationKind: Http.Path<AccessPolicyUpdateKind>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>, parameters: Http.Body<schema, 'application/json'>);
    /**
     ...
     * @since 2019-09-01
     */
    ListByResourceGroup(body?: Http.Body<file, 'application/json'>, resourceGroupName: Http.Path<string>, __top?: Http.Query<int32, '$top'>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>);
    /**
     ...
     * @since 2019-09-01
     */
    ListBySubscription(body?: Http.Body<file, 'application/json'>, __top?: Http.Query<int32, '$top'>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>);
    /**
     ...
     * @since 2019-09-01
     */
    ListDeleted(body?: Http.Body<file, 'application/json'>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>);
    /**
     ...
     * @since 2019-09-01
     */
    GetDeleted(body?: Http.Body<file, 'application/json'>, vaultName: Http.Path<string>, location: Http.Path<string>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>);
    /**
     ...
     * @since 2019-09-01
     */
    PurgeDeleted(body?: Http.Body<file, 'application/json'>, vaultName: Http.Path<string>, location: Http.Path<string>, api_version: Http.Query<string, 'api-version'>, subscriptionId: Http.Path<string>);
    /**
     * @description The List operation gets information about the vaults associated with the subscription.
     ...
     * @since 2019-09-01
     */
    CheckNameAvailability(api_version: Http.Query<string, 'api-version'>, vaultName: Http.Body<schema, 'application/json'>, subscriptionId: Http.Path<string>);
}
