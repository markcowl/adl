export interface Service {
     ...
     * @return 200 - Results are a comma separated value (CSV) file or a file containing a GeoJSON feature collection.
     */
    'air_rest_services.get_download'(output?: Http.Query<string>, qid: Http.Query<string>, qcolumns?: Http.Query<string>, p_pretty_print?: Http.Query<double>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     * Clean Air Act Download Data Service
     * @description Based on the QID obtained from a get_facilities or get_facility_info query, return a comma sepated vaule (CSV) file of the facilities found.
     * @since 0.0.0
     ...
     * @return 200 - Results are a comma separated value (CSV) file or a file containing a GeoJSON feature collection.
     */
    'air_rest_services.get_download'(output?: Http.FormData<string>, qid: Http.FormData<string>, qcolumns?: Http.FormData<string>, p_pretty_print?: Http.FormData<double>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     ...
     * @return 200 - Results are formatted as a GeoJSON feature collection.
     */
    'air_rest_services.get_geojson'(output?: Http.Query<string>, qid: Http.Query<string>, callback?: Http.Query<string>, newsort?: Http.Query<double>, descending?: Http.Query<"Y" | "N">, qcolumns?: Http.Query<string>, p_pretty_print?: Http.Query<double>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     * Clean Air Act GeoJSON Service
     * @description Based on the QID obtained from a get_facilities or get_facility_info query, return GeoJSON of the facilities found.
     * @since 0.0.0
     ...
     * @return 200 - Results are formatted as a GeoJSON feature collection.
     */
    'air_rest_services.get_geojson'(output?: Http.FormData<string>, qid: Http.FormData<string>, callback?: Http.FormData<string>, newsort?: Http.FormData<double>, descending?: Http.FormData<"Y" | "N">, qcolumns?: Http.FormData<string>, p_pretty_print?: Http.FormData<double>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     ...
     * @return 200 - Results are a comma separated value (CSV) file or a file containing a GeoJSON feature collection.
     */
    'air_rest_services.get_info_clusters'(output?: Http.Query<string>, p_qid: Http.Query<string>, p_pretty_print?: Http.Query<double>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     * Clean Air Act Info Clusters Service
     * @description Based on the QID obtained from a clustered get_facility_info query, download cluster facility information as either a CSV or GEOJSON file.
     * @since 0.0.0
     ...
     * @return 200 - Results are a comma separated value (CSV) file or a file containing a GeoJSON feature collection.
     */
    'air_rest_services.get_info_clusters'(output?: Http.FormData<string>, p_qid: Http.FormData<string>, p_pretty_print?: Http.FormData<double>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     ...
     * @return 200 - Results are either an array of State, County, Zip Code facility cluster map coordinates or individual facility coordinates.  Coordinates provided are in WGS84.
     */
    'air_rest_services.get_map'(output?: Http.Query<"JSONP" | "JSON" | "XML">, qid: Http.Query<string>, callback?: Http.Query<string>, tablelist?: Http.Query<"Y" | "N">, c1_lat?: Http.Query<double>, c1_long?: Http.Query<double>, c2_lat?: Http.Query<double>, c2_long?: Http.Query<double>, p_id: Http.Query<string>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     * Clean Air Act Map Service
     * @description The purpose of the GET_MAP service is to display facility coordinates and facility clusters related to a get_facilities facility query. Currently, the maximum number of coordinates returned is 500. GET_MAP performs automatic clustering at the state, county, and zip code levels to maximize the number of coordinates returned.
     * @since 0.0.0
     ...
     * @return 200 - Results are either an array of State, County, Zip Code facility cluster map coordinates or individual facility coordinates.  Coordinates provided are in WGS84.
     */
    'air_rest_services.get_map'(output?: Http.FormData<"JSONP" | "JSON" | "XML">, qid: Http.FormData<string>, callback?: Http.FormData<string>, tablelist?: Http.FormData<"Y" | "N">, c1_lat?: Http.FormData<double>, c1_long?: Http.FormData<double>, c2_lat?: Http.FormData<double>, c2_long?: Http.FormData<double>, p_id: Http.FormData<string>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     ...
     * @return 200 - Results are an array (page)  of CAA (ICIS Air) Facilities with the number of facilities equal to the responseset (page size).
     */
    'air_rest_services.get_qid'(output?: Http.Query<"JSONP" | "JSON" | "XML">, qid: Http.Query<string>, pageno?: Http.Query<double /* todo: add defaultValue '1' */>, callback?: Http.Query<string>, newsort?: Http.Query<double>, descending?: Http.Query<"Y" | "N">, qcolumns?: Http.Query<string>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     * Clean Air Act Search by Query ID
     * @description GET_QID is passed with a query ID corresponding to a previously run get_facilities query. It then returns a Facility object containing all matching facilities. The main purpose of GET_QID is for large querysets that contain multiple pages (responsesets) of output. GET_QID allows for pagination and for the selection and sorting of columns.
     * @since 0.0.0
     ...
     * @return 200 - Results are an array (page)  of CAA (ICIS Air) Facilities with the number of facilities equal to the responseset (page size).
     */
    'air_rest_services.get_qid'(output?: Http.FormData<"JSONP" | "JSON" | "XML">, qid: Http.FormData<string>, pageno?: Http.FormData<double /* todo: add defaultValue '1' */>, callback?: Http.FormData<string>, newsort?: Http.FormData<double>, descending?: Http.FormData<"Y" | "N">, qcolumns?: Http.FormData<string>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     ...
     * @return 200 - Results are an array of columns/objects.
     */
    'air_rest_services.metadata'(output?: Http.Query<"JSONP" | "JSON" | "XML">, callback?: Http.Query<string>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
    /**
     * Clean Air Act Metadata Service
     * @description Returns the JSON Object Name and ColumnId for usage with the qcolumns parameter for get_qid, get_facility_info and other service endpoints.
     * @since 0.0.0
     ...
     * @return 200 - Results are an array of columns/objects.
     */
    'air_rest_services.metadata'(output?: Http.FormData<"JSONP" | "JSON" | "XML">, callback?: Http.FormData<string>, body?: Http.Body<[object, Object], 'application/x-www-form-urlencoded'>): Http.Response<'200', [object, Object], 'application/json'> | Http.Response<'200', [object, Object], 'application/xml'>;
}
