export interface Service {
     ...
     * @return 200|application/xml - Results are a comma separated value (CSV) file or a file containing a GeoJSON feature collection.
     */
    'air_rest_services.get_download'(output?: FormData<string>, qid: f_qid, qcolumns?: f_qcolumns, p_pretty_print?: f_p_pretty_print): [(code: 200, mediaType: "application/json") => {
        body: file;
    }, (code: 200, mediaType: "application/xml") => {
        body: file;
    }];
     ...
     * @return 200|application/xml - Results are formatted as a GeoJSON feature collection.
     */
    'air_rest_services.get_geojson'(output?: FormData<string>, qid: f_qid, callback?: f_callback, newsort?: f_newsort, descending?: f_descending, qcolumns?: f_qcolumns, p_pretty_print?: f_p_pretty_print): [(code: 200, mediaType: "application/json") => {
        body: {
            /**
             * Features Array
             * @description Array of features in the feature collection.
     ...
     * @return 200|application/xml - Results are a comma separated value (CSV) file or a file containing a GeoJSON feature collection.
     */
    'air_rest_services.get_info_clusters'(output?: FormData<string>, p_qid: f_p_qid, p_pretty_print?: f_p_pretty_print): [(code: 200, mediaType: "application/json") => {
        body: file;
    }, (code: 200, mediaType: "application/xml") => {
        body: file;
    }];
     ...
     * @return 200|application/xml - Results are either an array of State, County, Zip Code facility cluster map coordinates or individual facility coordinates.  Coordinates provided are in WGS84.
     */
    'air_rest_services.get_map'(output?: FormData<"JSONP" | "JSON" | "XML">, qid: f_qid, callback?: f_callback, tablelist?: f_tablelist, c1_lat?: f_c1_lat, c1_long?: f_c1_long, c2_lat?: f_c2_lat, c2_long?: f_c2_long, p_id: f_p_id): [(code: 200, mediaType: "application/json") => {
        body: {
            /**
             *
             * @since 0.0.0
     ...
     * @return 200|application/xml - Results are an array (page)  of CAA (ICIS Air) Facilities with the number of facilities equal to the responseset (page size).
     */
    'air_rest_services.get_qid'(output?: FormData<"JSONP" | "JSON" | "XML">, qid: f_qid, pageno?: f_pageno, callback?: f_callback, newsort?: f_newsort, descending?: f_descending, qcolumns?: f_qcolumns): [(code: 200, mediaType: "application/json") => {
        body: {
            /**
             *
             * @since 0.0.0
     ...
     * @return 200|application/xml - Results are an array of columns/objects.
     */
    'air_rest_services.metadata'(output?: FormData<"JSONP" | "JSON" | "XML">, callback?: f_callback): [(code: 200, mediaType: "application/json") => {
        body: {
            /**
             *
             * @since 0.0.0
