export interface Service {
     ...
     */
    "air_rest_services.get_download"(output?: Query<string>, qid: q_qid, qcolumns?: q_qcolumns, p_pretty_print?: q_p_pretty_print, body?: Body<file, "application/x-www-form-urlencoded">): [(code: 200, mediaType: "application/json" | "application/xml") => {
        body: file;
    }];
    /**
     * Clean Air Act Download Data Service
     ...
     */
    "air_rest_services.get_geojson"(output?: Query<string>, qid: q_qid, callback?: q_callback, newsort?: q_newsort, descending?: q_descending, qcolumns?: q_qcolumns, p_pretty_print?: q_p_pretty_print, body?: Body<file, "application/x-www-form-urlencoded">): [(code: 200, mediaType: "application/json" | "application/xml") => {
        body: {
            /**
             * Features Array
     ...
     * @return 200 - Results are a comma separated value (CSV) file or a file containing a GeoJSON feature collection.
     */
    "air_rest_services.get_info_clusters"(output?: Query<string>, p_qid: q_p_qid, p_pretty_print?: q_p_pretty_print, body?: Body<file, "application/x-www-form-urlencoded">): [(code: 200, mediaType: "application/json" | "application/xml") => {
        body: file;
    }];
    /**
     * Clean Air Act Info Clusters Service
     ...
     */
    "air_rest_services.get_map"(output?: Query<"JSONP" | "JSON" | "XML">, qid: q_qid, callback?: q_callback, tablelist?: q_tablelist, c1_lat?: q_c1_lat, c1_long?: q_c1_long, c2_lat?: q_c2_lat, c2_long?: q_c2_long, p_id: q_p_id, body?: Body<file, "application/x-www-form-urlencoded">): [(code: 200, mediaType: "application/json" | "application/xml") => {
        body: {
            /**
             *
             * @since 0.0.0
     ...
     */
    "air_rest_services.get_qid"(output?: Query<"JSONP" | "JSON" | "XML">, qid: q_qid, pageno?: q_pageno, callback?: q_callback, newsort?: q_newsort, descending?: q_descending, qcolumns?: q_qcolumns, body?: Body<file, "application/x-www-form-urlencoded">): [(code: 200, mediaType: "application/json" | "application/xml") => {
        body: {
            /**
             *
             * @since 0.0.0
     ...
     */
    "air_rest_services.metadata"(output?: Query<"JSONP" | "JSON" | "XML">, callback?: q_callback, body?: Body<file, "application/x-www-form-urlencoded">): [(code: 200, mediaType: "application/json" | "application/xml") => {
        body: {
            /**
             *
             * @since 0.0.0
