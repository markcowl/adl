...
export interface Service {
    ...
    }, 'application/json'> | Http.Response<'HttpErrorResponse', schema, 'application/json'> | Http.Response<'HttpErrorResponse', schema, 'application/problem+json'>;
    /**
