export interface Service {
    ...
    }, 'application/json'> | Http.Response<'HttpErrorResponse', Error, 'application/json'> | Http.Response<'HttpErrorResponse', Problem, 'application/problem+json'>;
    /**
