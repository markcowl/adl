...
export type Http2XX = OK | Created | Accepted | NonAuthoritativeInformation | NoContent | ResetContent | PartialContent | MultiStatus | AlreadyReported | IMUsed | MultipleChoices;
export type Http3XX = MovedPermanently | Found | NotModified | UseProxy | SwitchProxy | TemporaryRedirect | PermanentRedirect;
